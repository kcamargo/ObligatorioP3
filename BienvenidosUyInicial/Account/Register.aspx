...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="ddlTipoUusario" CssClass="col-md-2 control-label">Tipo de usuario</asp:Label>
            <div class="col-md-10">
                <asp:DropDownList ID="ddlTipoUusario" runat="server">
                    <asp:ListItem Value="Anfitrion" Text="Anfitrion"></asp:ListItem>
                    <asp:ListItem Value="Huesped" Text="Huseped"></asp:ListItem>
                    <asp:ListItem Value="Chusma" Text="Chusma"></asp:ListItem>
                </asp:DropDownList>
            </div>
        </div>
