        ...
        <asp:Repeater ID="repAlojamientos" runat="server" OnItemCommand="repAlojamientos_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <asp:Label runat="server" ID="Label2" Text='<%# Eval("Nombre") %>' /></td>
                    <td>
                        <asp:Label runat="server" ID="Label3" Text='<%# Eval("TipoHabitacion") %>' /></td>
                    <td>
                        <asp:Label runat="server" ID="Label4" Text='<%# Eval("TipoBanio") %>' /></td>
                    <td>
                        <asp:Label runat="server" ID="Label5" Text='<%# Eval("CapacidadXPersona") %>' /></td>
                    <td>
                        <asp:Label runat="server" ID="Label6" Text='<%# Eval("Ciudad") %>' /></td>
                    <td>
                        <asp:Label runat="server" ID="Label7" Text='<%# Eval("Barrio") %>' /></td>
                    <td>
                        <asp:Label runat="server" ID="Label8" Text='<%# Eval("TipoAlojamiento") %>' /></td>
                    <td>
